...
router.post("/register", AuthMiddleware.verifyJWT, AuthMiddleware.isAdmin, UserController.registerUser); // This will be protected by the AuthMiddleware in the future
